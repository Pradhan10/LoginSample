package com.pradhanrishisharma.www.loginsample.NetwrokCheckModule;//package com.delaroystudios.cardview;
...
import com.pradhanrishisharma.www.loginsample.Album;
import com.pradhanrishisharma.www.loginsample.AlbumsAdapter;
import com.pradhanrishisharma.www.loginsample.R;

import java.util.ArrayList;
import java.util.List;

public class MinisterHome extends AppCompatActivity {

    private RecyclerView recyclerView;
    private com.pradhanrishisharma.www.loginsample.AlbumsAdapter adapter;
    private List<Album> albumList;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_minister_home);
